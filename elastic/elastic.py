...
def get_cij_order(cryst):
    orders = {
            1: ('C_{11}', 'C_{22}', 'C_{33}', 'C_{12}', 'C_{13}', 'C_{23}',
                'C_{44}', 'C_{55}', 'C_{66}', 'C_{16}', 'C_{26}', 'C_{36}',
                'C_{46}', 'C_{56}', 'C_{14}', 'C_{15}', 'C_{25}', 'C_{45}'),
            2: ('C_{11}', 'C_{22}', 'C_{33}', 'C_{12}', 'C_{13}', 'C_{23}',
                'C_{44}', 'C_{55}', 'C_{66}', 'C_{16}', 'C_{26}', 'C_{36}',
                'C_{45}'),
            3: ('C_{11}', 'C_{22}', 'C_{33}', 'C_{12}', 'C_{13}', 'C_{23}',
                'C_{44}', 'C_{55}', 'C_{66}'),
            4: ('C_{11}', 'C_{33}', 'C_{12}', 'C_{13}', 'C_{44}', 'C_{14}'),
            5: ('C_{11}', 'C_{33}', 'C_{12}', 'C_{13}', 'C_{44}', 'C_{14}'),
            6: ('C_{11}', 'C_{33}', 'C_{12}', 'C_{13}', 'C_{44}'),
            7: ('C_{11}', 'C_{12}', 'C_{44}'),
            }
