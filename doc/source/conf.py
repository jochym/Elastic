...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.jsmath', 'sphinx.ext.viewcode']
...
project = u'Elastic'
copyright = u'2011, Paweł T. Jochym'
...
latex_documents = [
  ('index', 'Elastic.tex', u'Elastic Documentation',
...
epub_copyright = u'2011, Paweł T. Jochym'
